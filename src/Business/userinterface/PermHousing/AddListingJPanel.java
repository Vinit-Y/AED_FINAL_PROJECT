    ...
    public AddListingJPanel(JPanel userProcessContainer, UserAccount account, Organization permHousingOrganization, Enterprise enterprise, CitizenDirectory vd,EcoSystem business) 
 {
   ...
   public HouseListingDirectory getDir() {
    ...
    private void initComponents() {
        ...
        add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 340, -1, -1));
        ...
        add(btnAdd, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 430, -1, -1));

        jLabel6.setFont(new java.awt.Font("Lucida Grande", 1, 24)); // NOI18N
        jLabel6.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel6.setText("Add Permanent House Listing");
        add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 10, -1, 40));

        btnBack.setBackground(new java.awt.Color(204, 204, 255));
        btnBack.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        btnBack.setText("<<BACK");
        add(btnBack, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 480, 90, -1));
